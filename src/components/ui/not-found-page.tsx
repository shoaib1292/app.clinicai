...
export function NotFoundPage({
  ...
  return (
    <motion.div
      ...
      className={cn("flex min-h-[calc(100vh-200px)] flex-col items-center justify-center space-y-6 text-center px-4", className)}
    >
      <motion.div
      ...
      >
        {icon ?? <Stethoscope className="mx-auto h-24 w-24 text-muted-foreground" />}
      </motion.div>
